...
def deepseek_v4_dense_decode_fwd(*args, **kwargs):
    return _infinicore.deepseek_v4_dense_decode_fwd(*args, **kwargs)
...
def deepseek_v4_sparse_decode_fwd(*args, **kwargs):
    return _infinicore.deepseek_v4_sparse_decode_fwd(*args, **kwargs)
