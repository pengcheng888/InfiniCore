...
from .module import Module_wpc

class Linear(Module_wpc):
    ...
    def __init__(
        ...
        self.weight = infinicore.nn.Parameter_wpc(
            infinicore.empty((1, 1), dtype=infinicore.float32, device=infinicore.device("cpu", 0))
        )
