...
def check_tensors():
    ...
    from safetensors import safe_open
    model_path = r"/home/ubuntu/models/TinyLlama-1.1B-Chat-v1.0-small/layer_0_model.safetensors"
    tensors = {}
...
def modify_tensors():
    ...
    model_path = r"/home/ubuntu/models/TinyLlama-1.1B-Chat-v1.0-small/model.safetensors"
