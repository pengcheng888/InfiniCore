...
void topkrouter_cpu_one_token(float* values_input, int* indices_input,
                                   ...
                                   const bool norm_topk_prob = true)
{
  ...
  */
  for (size_t n = 0; n < N; ++n)
  {
    ...
    topkrouter_cpu_one_token(values_input, indices_input, x_input, correction_bias, routed_scaling_factor, topk, width,
