...
// 1. 创建算子描述符
// =======================================================================
__C infiniStatus_t infiniopCreateBroadcastToDescriptor(
...
// 2. 获取 Workspace 大小
// =======================================================================
__C infiniStatus_t infiniopGetBroadcastToWorkspaceSize(infiniopBroadcastToDescriptor_t desc, size_t *size) {
...
// 3. 执行计算 (Calculate)
// =======================================================================
__C infiniStatus_t infiniopBroadcastTo(
...
// 4. 销毁算子描述符
// =======================================================================
__C infiniStatus_t infiniopDestroyBroadcastToDescriptor(infiniopBroadcastToDescriptor_t desc) {
