...
#include "mxfp4_dequantize_moore.h"

#include "../../mxfp4_common/cuda/mxfp4_kernel.cuh"

namespace op::mxfp4_dequantize::moore {
namespace {

template <typename T>
INFINIOP_MOORE_KERNEL dequantize_kernel(
    T *out,
...
infiniStatus_t Descriptor::calculate(
    ...
    case INFINI_DTYPE_F16:
        launch(reinterpret_cast<half *>(out), packed_ptr, scales_ptr, _info, moore_stream);
        return INFINI_STATUS_SUCCESS;
    case INFINI_DTYPE_BF16:
        launch(reinterpret_cast<__nv_bfloat16 *>(out), packed_ptr, scales_ptr, _info, moore_stream);
        return INFINI_STATUS_SUCCESS;
    case INFINI_DTYPE_F32:
        launch(reinterpret_cast<float *>(out), packed_ptr, scales_ptr, _info, moore_stream);
        return INFINI_STATUS_SUCCESS;
    default:
