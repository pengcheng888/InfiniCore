...
INFINIOP_MOORE_KERNEL flashAttentionDecodeMlaHd576V512Warp(
    Tdata *out_,
    const Tdata *q_,
...
template <typename Tindex, typename Tdata>
INFINIOP_MOORE_KERNEL flashAttentionDecodeMlaHd576V512SplitKv(
    float *partial_acc,
    float *partial_m,
    float *partial_l,
    const Tdata *q_,
...
INFINIOP_MOORE_KERNEL flashAttentionDecodeMlaHd576V512SplitKvCombine(
    Tdata *out_,
