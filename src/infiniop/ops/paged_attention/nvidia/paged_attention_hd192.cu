...
INFINIOP_CUDA_KERNEL flashAttentionDecodeHd192Warp(
    Tdata *out,
    const Tdata *q,
    const Tdata *k_cache,
    const Tdata *v_cache,
...
template <typename Tindex, typename Tdata>
INFINIOP_CUDA_KERNEL flashAttentionDecodeHd192SplitKv(
    float *partial_acc,
    float *partial_m,
    float *partial_l,
    const Tdata *q,
...
INFINIOP_CUDA_KERNEL flashAttentionDecodeHd192SplitKvCombine(
    Tdata *out,
