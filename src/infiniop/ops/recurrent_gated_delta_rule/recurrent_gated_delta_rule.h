// infiniop/ops/recurrent_gated_delta_rule.h

#ifndef __INFINIOP_RECURRENT_GATED_DELTA_RULE_H__
...
#define DESCRIPTOR(NAMESPACE)                                      \
                                                                   \
    namespace op::recurrent_gated_delta_rule::NAMESPACE {          \
    class Descriptor final : public InfiniopDescriptor {           \
        struct Opaque;                                             \
        Opaque *_opaque;                                           \
        RecurrentGatedDeltaRuleInfo _info;                         \
...
#endif // __INFINIOP_RECURRENT_GATED_DELTA_RULE_H__
