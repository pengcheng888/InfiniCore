...
template <>
__device__ __forceinline__ __mt_bfloat16 cast_pad_value<__mt_bfloat16>(double v) {
...
infiniStatus_t Descriptor::calculate(
    ...
    CHECK_MOORE(musaMemcpyAsync(workspace, meta.data(), required, musaMemcpyHostToDevice, musa_stream));
    ...
    case INFINI_DTYPE_F16:
        pad_kernel<half><<<grid, BLOCK, 0, musa_stream>>>(
    ...
    case INFINI_DTYPE_BF16:
        pad_kernel<__mt_bfloat16><<<grid, BLOCK, 0, musa_stream>>>(
            reinterpret_cast<__mt_bfloat16 *>(y),
            reinterpret_cast<const __mt_bfloat16 *>(x),
            _ndim,
            d_in_shape,
            d_out_shape,
            d_in_strides,
    ...
    case INFINI_DTYPE_F32:
        pad_kernel<float><<<grid, BLOCK, 0, musa_stream>>>(
    ...
    case INFINI_DTYPE_F64:
        pad_kernel<double><<<grid, BLOCK, 0, musa_stream>>>(
