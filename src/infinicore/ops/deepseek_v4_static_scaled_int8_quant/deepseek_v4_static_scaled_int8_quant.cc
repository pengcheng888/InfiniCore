#include "infinicore/ops/deepseek_v4_static_scaled_int8_quant.hpp"
...
void deepseek_v4_static_scaled_int8_quant_(Tensor result,
    ...
    if (input->device().getType() != Device::Type::HYGON) {
        throw std::runtime_error("deepseek_v4_static_scaled_int8_quant_ expects HYGON tensors in this build.");
    }
    c10::hip::HIPStreamGuard guard(infinicore::adaptor::get_hip_stream());
#else
    if (input->device().getType() != Device::Type::NVIDIA) {
        throw std::runtime_error("deepseek_v4_static_scaled_int8_quant_ expects NVIDIA tensors in this build.");
    }
    ...
    static auto op = c10::Dispatcher::singleton()
                         ...
                         .typed<void(at::Tensor &, const at::Tensor &, const at::Tensor &, const std::optional<at::Tensor> &)>();
    ...
    (void)scale;
    (void)azp;
    throw std::runtime_error("deepseek_v4_static_scaled_int8_quant_ requires an ATen-enabled HYGON/NVIDIA build.");
#endif
}
