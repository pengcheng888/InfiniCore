...
void deepseek_v4_c4_act_quant_fused_scale_kernel_(const Tensor &q,
    ...
    deepseek_v4_sparse_attn_indexer::launch_c4_act_quant_fused_scale(
        q->data(),
        c4_scalar_type_for_kernel(q, "deepseek_v4_c4_act_quant_fused_scale_kernel_"),
        indexer_weights->data(),
        c4_scalar_type_for_kernel(indexer_weights, "deepseek_v4_c4_act_quant_fused_scale_kernel_"),
    ...
    (void)fused_weights;
    (void)weight_scale;
    throw std::runtime_error("deepseek_v4_c4_act_quant_fused_scale_kernel_ requires an ATen-enabled HYGON build.");
#endif
}
...
void deepseek_v4_topk_transform_512_kernel_(const Tensor &scores,
                                            ...
                                            int page_size) {
#if defined(ENABLE_ATEN) && defined(ENABLE_HYGON_API)
    check_hygon_tensor(scores, "deepseek_v4_topk_transform_512_kernel_");
    c10::hip::HIPStreamGuard guard(infinicore::adaptor::get_hip_stream());
