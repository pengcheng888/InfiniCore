...
INFINICORE_GRAPH_OP_DISPATCHERS_IMPL(DeepseekV4MhcFusedPostPreKernel);
...
DeepseekV4MhcFusedPostPreKernel::DeepseekV4MhcFusedPostPreKernel(Tensor residual_cur,
                                                                 Tensor post_mix_cur,
                                                                 Tensor comb_mix_cur,
...
void DeepseekV4MhcFusedPostPreKernel::execute(Tensor residual_cur,
                                              Tensor post_mix_cur,
                                              Tensor comb_mix_cur,
                                              Tensor layer_input_cur,
                                              const Tensor &x,
    ...
    if (mhc_graph_debug_enabled()) {
        std::fprintf(stderr,
                     "[infinicore graph] execute DeepseekV4MhcFusedPostPreKernel recording=%d\n",
                     context::isGraphRecording() ? 1 : 0);
    }
    INFINICORE_GRAPH_OP_RECORD_OR_RUN(DeepseekV4MhcFusedPostPreKernel,
                                      residual_cur,
                                      post_mix_cur,
                                      comb_mix_cur,
                                      layer_input_cur,
...
namespace deepseek_v4_mhc_fused_post_pre_graph_impl {
...
void run(void *planned_meta) {
    ...
    if (mhc_graph_debug_enabled()) {
        std::fprintf(stderr,
                     "[infinicore graph] run DeepseekV4MhcFusedPostPreKernel tokens=%ld hc=%ld hidden=%ld\n",
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(DeepseekV4MhcFusedPostPreKernel,
                                       &deepseek_v4_mhc_fused_post_pre_graph_impl::plan,
                                       &deepseek_v4_mhc_fused_post_pre_graph_impl::run,
                                       &deepseek_v4_mhc_fused_post_pre_graph_impl::cleanup);
} // namespace deepseek_v4_mhc_fused_post_pre_register
...
void deepseek_v4_mhc_fused_post_pre_kernel_(Tensor residual_cur,
    ...
    DeepseekV4MhcFusedPostPreKernel::execute(residual_cur,
                                             post_mix_cur,
                                             comb_mix_cur,
                                             layer_input_cur,
                                             x,
