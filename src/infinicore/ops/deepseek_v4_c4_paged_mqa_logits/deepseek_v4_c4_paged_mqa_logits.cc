...
void deepseek_v4_c4_paged_mqa_logits_impl(const Tensor &q_fp8,
...
namespace deepseek_v4_c4_paged_mqa_logits_graph_impl {
...
#if defined(ENABLE_ATEN) && defined(ENABLE_HYGON_API)
    deepseek_v4_c4_paged_mqa_logits_impl(planned->q_fp8,
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(DeepseekV4C4PagedMqaLogits,
                                       &deepseek_v4_c4_paged_mqa_logits_graph_impl::plan,
                                       &deepseek_v4_c4_paged_mqa_logits_graph_impl::run,
                                       &deepseek_v4_c4_paged_mqa_logits_graph_impl::cleanup);
} // namespace deepseek_v4_c4_paged_mqa_logits_register
...
void deepseek_v4_c4_paged_mqa_logits_(const Tensor &q_fp8,
                                      ...
                                      bool clean_logits) {
#if defined(ENABLE_ATEN) && defined(ENABLE_HYGON_API)
    DeepseekV4C4PagedMqaLogits::execute(q_fp8,
                                        fused_weights,
                                        indexer_kv_cache_raw,
                                        c4_seq_lens,
                                        page_table,
