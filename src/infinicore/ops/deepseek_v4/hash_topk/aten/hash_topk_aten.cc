...
void hash_topk_aten_(Tensor topk_weights,
    ...
    detail::prepare_aten_call(router_logits, "deepseek_v4::hash_topk_aten_");
    ...
    (void)scoring_func;
    throw std::runtime_error("deepseek_v4::hash_topk_aten_ requires an ATen-enabled HYGON/NVIDIA/METAX/ILUVATAR build.");
#endif
}
