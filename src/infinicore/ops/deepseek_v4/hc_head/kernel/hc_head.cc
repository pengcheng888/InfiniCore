...
#else
    (void)planned_meta;
    throw std::runtime_error("hc_head_kernel_ requires an ATen-enabled HYGON/NVIDIA build.");
#endif
}
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(HcHead, &hc_head_impl::plan_head, &hc_head_impl::run_head, &hc_head_impl::cleanup_head);
} // namespace hc_head_register
