...
#else
    (void)planned_meta;
    throw std::runtime_error("mhc_post_kernel_ requires an ATen-enabled HYGON/NVIDIA build.");
#endif
}
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(MhcPost, &mhc_post_impl::plan_post, &mhc_post_impl::run_post, &mhc_post_impl::cleanup_post);
} // namespace mhc_post_register
