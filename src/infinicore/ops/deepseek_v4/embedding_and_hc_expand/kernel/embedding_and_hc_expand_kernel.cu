...
namespace infinicore::op::deepseek_v4::embedding_and_hc_expand_kernel_impl {
namespace {
...
void launch_for_index(void *out,
    ...
    throw std::runtime_error("embedding_and_hc_expand_kernel_ expects int32 or int64 input indices.");
}
...
void launch_embedding(void *out,
    ...
    throw std::runtime_error("embedding_and_hc_expand_kernel_ supports bf16/fp16/fp32 output tensors only.");
}
