...
namespace deepseek_v4_compress_norm_rope_store_impl {
...
void run(void *planned_meta) {
    ...
    ::infinicore::op::deepseek_v4_compress_norm_rope_store::launch_compress_norm_rope_store(
        planned->kv->data(),
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(DeepseekV4CompressNormRopeStoreKernel,
                                       &deepseek_v4_compress_norm_rope_store_impl::plan,
                                       &deepseek_v4_compress_norm_rope_store_impl::run,
                                       &deepseek_v4_compress_norm_rope_store_impl::cleanup);
} // namespace deepseek_v4_compress_norm_rope_store_register
...
void deepseek_v4_compress_norm_rope_store_kernel_(const Tensor &kv,
    ...
    check_compress_norm_rope_store_shapes(kv,
                                          ...
                                          page_size,
                                          "deepseek_v4_compress_norm_rope_store_kernel_");
    deepseek_v4::DeepseekV4CompressNormRopeStoreKernel::execute(kv,
                                                                norm_weight,
                                                                epsilon,
                                                                freqs_cis,
                                                                positions,
