...
void DeepseekV4MhcPost::execute(Tensor y,
                                ...
                                const Tensor &post,
                                const Tensor &comb) {
    INFINICORE_GRAPH_OP_RECORD_OR_RUN(DeepseekV4MhcPost, y, x, residual, post, comb);
}

namespace deepseek_v4_mhc_post_impl {
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(DeepseekV4MhcPost, &deepseek_v4_mhc_post_impl::plan_post, &deepseek_v4_mhc_post_impl::run_post, &deepseek_v4_mhc_post_impl::cleanup_post);
} // namespace deepseek_v4_mhc_post_register
...
void deepseek_v4_mhc_post_kernel_(Tensor y,
                                  ...
                                  const Tensor &post,
                                  const Tensor &comb) {
    deepseek_v4::DeepseekV4MhcPost::execute(y, x, residual, post, comb);
}
