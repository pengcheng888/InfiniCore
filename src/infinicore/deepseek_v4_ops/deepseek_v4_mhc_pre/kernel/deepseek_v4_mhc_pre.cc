...
INFINICORE_GRAPH_OP_DISPATCHERS_IMPL(DeepseekV4MhcPre);
...
DeepseekV4MhcPre::DeepseekV4MhcPre(Tensor y,
                                   Tensor post,
                                   Tensor comb,
...
void DeepseekV4MhcPre::execute(Tensor y,
                                Tensor post,
                                Tensor comb,
                                const Tensor &residual,
                                const Tensor &fn,
                                ...
                                double hc_sinkhorn_eps,
                                int sinkhorn_repeat) {
    INFINICORE_GRAPH_OP_RECORD_OR_RUN(DeepseekV4MhcPre,
                                      y,
                                      post,
                                      comb,
                                      residual,
...
namespace deepseek_v4_mhc_pre_impl {
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(DeepseekV4MhcPre,
                                       &deepseek_v4_mhc_pre_impl::plan_pre,
                                       &deepseek_v4_mhc_pre_impl::run_pre,
                                       &deepseek_v4_mhc_pre_impl::cleanup_pre);
} // namespace deepseek_v4_mhc_pre_register
...
void deepseek_v4_mhc_pre_kernel_(Tensor y,
                                 ...
                                 double hc_sinkhorn_eps,
                                 int sinkhorn_repeat) {
    deepseek_v4::DeepseekV4MhcPre::execute(y, post, comb, residual, fn, hc_scale, hc_base, rms_eps, hc_pre_eps, hc_sinkhorn_eps, sinkhorn_repeat);
}
