...
namespace deepseek_v4_c4_compress_sglang_stateful_impl {
...
void run(void *planned_meta) {
    ...
    deepseek_v4_c4_compress_sglang_stateful_kernel_impl::launch_c4_compress_stateful_sglang(
        planned->output->data(),
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(DeepseekV4C4CompressSglangStatefulKernel,
                                       &deepseek_v4_c4_compress_sglang_stateful_impl::plan,
                                       &deepseek_v4_c4_compress_sglang_stateful_impl::run,
                                       &deepseek_v4_c4_compress_sglang_stateful_impl::cleanup);
} // namespace deepseek_v4_c4_compress_sglang_stateful_register
...
Tensor deepseek_v4_c4_compress_sglang_stateful_kernel(const Tensor &kv_score_input,
    ...
    deepseek_v4::DeepseekV4C4CompressSglangStatefulKernel::execute(output,
                                                                   kv_score_input,
                                                                   ape,
                                                                   compressor_state,
                                                                   write_loc,
