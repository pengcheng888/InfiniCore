...
void deepseek_v4_mhc_fused_post_pre_aten_(Tensor residual_cur,
    ...
    if (hc_post_mult_value != 2.0) {
        throw std::runtime_error("deepseek_v4_mhc_fused_post_pre_aten_ currently expects hc_post_mult_value == 2.0.");
    }
    deepseek_v4_mhc_post_aten_(residual_cur, x, residual, post_layer_mix, comb_res_mix);
    deepseek_v4_mhc_pre_aten_(layer_input_cur,
                              post_mix_cur,
                              comb_mix_cur,
                              residual_cur,
                              fn,
