...
void run_fused_q_indexer_rope_hadamard_quant_sglang(const Tensor &q_input,
                                                    Tensor q_fp8,
                                                    const Tensor &weight,
                                                    Tensor weights_out,
                                                    float weight_scale,
...
namespace deepseek_v4_fused_q_indexer_rope_hadamard_quant_sglang_impl {
...
void run(void *planned_meta) {
    ...
    run_fused_q_indexer_rope_hadamard_quant_sglang(planned->q_input,
                                                   planned->q_fp8,
                                                   planned->weight,
                                                   planned->weights_out,
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(DeepseekV4FusedQIndexerRopeHadamardQuantSglangKernel,
                                       &deepseek_v4_fused_q_indexer_rope_hadamard_quant_sglang_impl::plan,
                                       &deepseek_v4_fused_q_indexer_rope_hadamard_quant_sglang_impl::run,
                                       &deepseek_v4_fused_q_indexer_rope_hadamard_quant_sglang_impl::cleanup);
} // namespace deepseek_v4_fused_q_indexer_rope_hadamard_quant_sglang_register
...
void deepseek_v4_fused_q_indexer_rope_hadamard_quant_sglang_kernel_(const Tensor &q_input,
                                                                    ...
                                                                    const Tensor &freqs_cis,
                                                                    const Tensor &positions) {
    deepseek_v4::DeepseekV4FusedQIndexerRopeHadamardQuantSglangKernel::execute(q_input, q_fp8, weight, weights_out, weight_scale, freqs_cis, positions);
    return;
}
