...
inline void bind(pybind11::module &m) {
    ...
    pybind11::class_<py::Tensor>(m, "Tensor")
        ...
        .def("data_ptr", &py::Tensor::data)
        .def_property_readonly("shape", &py::Tensor::shape)
        .def_property_readonly("strides", &py::Tensor::strides)
        .def("size", &py::Tensor::size)
        .def("stride", &py::Tensor::stride)
        .def_property_readonly("dtype", &py::Tensor::dtype)
        .def_property_readonly("device", &py::Tensor::device)
        .def("is_contiguous", &py::Tensor::is_contiguous)
        .def_property_readonly("ndim", &py::Tensor::ndim)
