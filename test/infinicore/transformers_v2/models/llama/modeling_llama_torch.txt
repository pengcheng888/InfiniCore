...
class LlamaAttention_infinicore(nn.Module):
    ...
    def forward(
        ...
        if True:
            ...
            query_states = infini_tensor_2_torch_tensor(query_states)
            key_states = infini_tensor_2_torch_tensor(key_states)
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            inputs_embeds: torch.Tensor = self.embed_tokens(input_ids.to(dtype=torch.int32))
