...
from framework.utils import is_broadcast, infinicore_tensor_from_torch
...
_TEST_CASES_DATA = [
    ...
    (1, 1, 64, _infinicore.Algo.GPT_NEOX),
    (5, 32, 64, _infinicore.Algo.GPT_NEOX),
    (1, 1, 128, _infinicore.Algo.GPT_J),
    (10, 1, 64, _infinicore.Algo.GPT_J),
]
...
def rotary_embedding(ans, t, sin, cos, algo=_infinicore.Algo.GPT_NEOX):
    ...
    if _infinicore.Algo.GPT_J == algo:
    ...
    elif _infinicore.Algo.GPT_NEOX == algo:
        half_dim = dh // 2
        t_first = t[..., :half_dim]
        t_second = t[..., half_dim:]
