...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "../python-lm"))
...
if __name__ == "__main__":
    ...
    # python  python examples/llama.py --nvidia --model_path=/home/ubuntu/workspace_aisys/tensorRT_quantization-main/Llama/Llama2-TinyLlama-1.1B-Chat-v1.0/
