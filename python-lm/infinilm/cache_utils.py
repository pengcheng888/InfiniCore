...
class Cache:
    ...
    def update(
        ...
        # --------------------------------------------------------------------------------------- #
        #                           infinicore 转 torch.Tensor
        # --------------------------------------------------------------------------------------- #
        import infinicore

        key_states = infinicore.convert_infini_to_torch_tensor(key_states).permute(
            (0, 2, 1, 3)
        )
        value_states = infinicore.convert_infini_to_torch_tensor(
        ...
        # --------------------------------------------------------------------------------------- #
        #                        torch.Tensor 转  infinicore
        # --------------------------------------------------------------------------------------- #
        key_states_infini = infinicore.from_torch(keys.contiguous())
        value_states_infini = infinicore.from_torch(values.contiguous())
        # return keys, values
