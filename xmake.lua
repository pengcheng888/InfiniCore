...
target("infinicore_cpp_api")
    ...
    if has_config("hygon-dcu") and has_config("aten") then
        ...
        add_links("cudart", "hipblas", "rocblas")
        ...
        add_files("src/infinicore/ops/deepseek_v4_mhc_pre/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_mhc_post/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_hc_head/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_linear_bf16_fp32/*.cu")
        ...
        add_files("src/infinicore/ops/deepseek_v4_lightop_linear_w8a8_asm/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_lightop_linear_w8a8_smooth/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_lmslim_rocblas_linear_w8a8/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_expand_hc/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_hash_topk/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_biased_topk/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_silu_and_mul/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_flashmla_cache/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_flashmla_compute/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_compress_norm_rope_store/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_indexer_compress_norm_rope_store/*.cu")
        ...
        add_files("src/infinicore/ops/deepseek_v4_fused_q_indexer_rope_hadamard_quant_sglang/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_sparse_attn_indexer/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_topk_transform_512/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_rmsnorm_self/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_fused_rope/*.cu")
