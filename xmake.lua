...
target("infinicore_cpp_api")
    ...
    if has_config("hygon-dcu") and has_config("aten") then
        ...
        add_files("src/infinicore/ops/deepseek_v4_mhc_fused_post_pre/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_hc_head/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_linear_bf16_fp32/*.cu")
        add_files("src/infinicore/ops/deepseek_v4_embedding_and_hc_expand/*.cu")
        ...
        add_files("src/infinicore/ops/deepseek_v4_compress_sglang_stateful/*.cu")
